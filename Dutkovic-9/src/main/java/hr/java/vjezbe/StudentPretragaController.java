...
public class StudentPretragaController {
    ...
    public void dohvatiStudente(){
        ...
        if(datumRodenjaStudentaTextField != null) {
           datumRodenjaStudenta = datumRodenjaStudentaTextField.getValue();
        }

        List<Student> filtriraniStudenti = null;
        try {
            filtriraniStudenti = BazaPodataka.dohvatiStudentePremaKriterijima(new Student(null, imeStudenta, prezimeStudenta, jmbagStudenta, datumRodenjaStudenta));
        } catch (BazaPodatakaException e) {
            throw new RuntimeException(e);
        }
